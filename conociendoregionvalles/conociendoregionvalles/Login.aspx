<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="conociendoregionvalles.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    ...
                    <a href="Registro.aspx">Registrarse</a>  si no tiene una cuenta local.
                </p>
            </section>
        </div>
