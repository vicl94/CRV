<%@ Page Title="Registrarse" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="conociendoregionvalles.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="txtCompanyName" CssClass="col-md-2 control-label">Nombre de Empresa (Compañia)</asp:Label>
            <div class="col-md-10">
                ...
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCompanyName"
                    CssClass="text-danger" ErrorMessage="El campo de Nombre de Empresa (Compañia) es obligatorio." />
            </div>
        </div>
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="selectRegion" CssClass="col-md-2 control-label">Comunidad</asp:Label>
            <div class="col-md-10">
                <select class="form-control" id="selectRegion" runat="server"  ClientIdMode="Static" style="width:200px">
                </select>
            </div>
        </div>
        <div class="form-group">
